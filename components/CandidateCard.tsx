...
const CandidateCard: React.FC<CandidateCardProps> = ({ match }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6 flex flex-col md:flex-row items-center md:items-start gap-6 transition-shadow duration-300 hover:shadow-2xl">
      ...
      <div className="flex-grow w-full text-center md:text-left">
        ...
        <div className="mt-4 pt-4 border-t border-slate-200">
          <h4 className="font-semibold text-slate-700 flex items-center justify-center md:justify-start"><SparklesIcon className="w-5 h-5 mr-2 text-energy"/> AI Match Explanation</h4>
